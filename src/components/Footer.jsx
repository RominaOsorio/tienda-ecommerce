          ...
          <div className='col-12 col-md-3'>
            <Card className='border-0 card-footer bg-dark text-light'>
              <Card.Body className='d-flex justify-content-center'>
                <Card.Text className='mx-1'><FaSquareXTwitter size={36} /></Card.Text>
                <Card.Text className='mx-1'><FaSquareFacebook size={36} /></Card.Text>
                <Card.Text className='mx-1'><FaSquareInstagram size={36} /></Card.Text>
              </Card.Body>
            </Card>
          </div>
        </Row>
